...
Beside consumming, the guide describe how to install and run the services locally on your computer.
...
NOTE: HTTP address will be the location of the company as it was returned in response of <<Create Company>> service.
